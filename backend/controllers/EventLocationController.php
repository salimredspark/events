...
use backend\models\EventLocationSearch;
...
class EventLocationController extends Controller
{
    ...
    {
        $searchModel = new EventLocationSearch();
    ...
    /**
     * Finds the EventLocation model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return EventLocation the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = EventLocation::findOne($id)) !== null) {
            return $model;
        }
