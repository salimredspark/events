    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header" data-background-color="purple">
                <h4 class="title"><?php echo ($model->id)?'Update':'Create';?> Speaker Accommodation for <?=$modelEventShow->show_name;?></h4>
                <p class="category">Add Speaker Accommodation</p>
            </div>
            <div class="card-content">
                <?php $form = ActiveForm::begin(); ?>
                <?php foreach($modelIsEventSpeaker as $showObj){?>
                <div class="row">                        
                    <div class="col-md-2">                                                
                        <?php 
                            ...
                            'labelOptions' => [ 'class' => 'control-label', 'label' => 'Speaker' ]
                            ])->dropDownList( $items, ['prompt'=>''] );
                        ?>                        
                    </div>
                    <div class="col-md-2">                                                
                        <?php 
                            $items = ['Hotels','Bookay', 'Pick From'];
                     ...
                     <div class="col-md-6">
                            <?php 
                                ...
                                'labelOptions' => [ 'class' => 'control-label', 'label' => 'Category Item' ]
